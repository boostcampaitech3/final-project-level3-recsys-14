...
def check_main_rival(db):
    print("KNN-------")
    knn_result = pd.read_csv('/opt/ml/airflow/dags/module_models/rec_rival/knn_prog/rec_rival_knn.csv')
    ...
    print("CMF-------")
    cmf_result = pd.read_csv('/opt/ml/airflow/dags/module_models/rec_rival/cmf_prog/rec_rival_cmf.csv')
